...
const App = () => {
  ...
  return (
    <div>
      <Header className="header container-fluid p-5 bg-dark text-success text-center" />
      ...
      <div className="container-fluid text-center">
        ...
        <p>Количество книг: {cart.length} </p>
              ...
              <div className="row">
                ...
                <div className="col-2">
                  <button
                    ...
                    type="button"
                    className="btn btn-outline-success mt-auto mb-2"
                  >
                    Убрать
                  </button>
                </div>
